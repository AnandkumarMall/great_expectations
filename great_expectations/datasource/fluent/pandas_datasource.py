...
_GBQ_ASSET_MANUALLY_CREATED: bool = False
if GBQAsset is _PandasDataAsset:
    ...
    class GBQAsset(_PandasDataAsset):  # type: ignore[no-redef]
        ...
        class Config:
            ...
            # from its signature. Extra fields must be allowed so that kwargs like
            # `project_id` and `credentials` are accepted and passed through to the reader.
            extra = pydantic.Extra.allow

...
def column_pair_condition_partial(  # noqa: C901, PLR0912, PLR0915 #  16
...
"column_pair_condition_partial" "partial_fn_type" property."""  # noqa: E501 # FIXME CoP
            )
        ...
        def wrapper(metric_fn: Callable):
            ...
            def inner_func(  # noqa: PLR0913 # FIXME CoP
                ...
                expected_condition = metric_fn(
                    cls,
                    quote_ident(column_A_name),
                    quote_ident(column_B_name),
                    **metric_value_kwargs,
                    _relation=relation,
                    _metrics=metrics,
                )

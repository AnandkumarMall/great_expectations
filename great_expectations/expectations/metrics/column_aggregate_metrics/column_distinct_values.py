...
class ColumnDistinctValuesNotEqualSet(ColumnAggregateMetricProvider):
    """Metric that returns values that differ between column and expected set.
    ...
    def _pandas(
        ...
        expected_set = set(value_set)

        in_column_not_in_set = list(column_set - expected_set)[:limit]
        in_set_not_in_column = list(expected_set - column_set)[:limit]
    ...
    def _sqlalchemy(
        ...
        **kwargs,
        ...
        """Return values that differ between column and expected set."""
        ...
        # Find differences
        in_column_not_in_set = list(column_values_set - expected_set)[:limit]
        in_set_not_in_column = list(expected_set - column_values_set)[:limit]

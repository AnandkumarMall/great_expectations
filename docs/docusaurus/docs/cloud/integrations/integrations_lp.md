...
<LinkCardGrid>
  ...
  <LinkCard topIcon label="Jira" description="Enable incident management that links Expectation failures to new or existing Jira work items." to="/cloud/integrations/integrate_jira" icon="/img/jira_logo.png"/>

...
For an audit trail of who removed or edited which deleted Expectations and when, [view Data Asset history](/cloud/data_assets/manage_data_assets.md#view-data-asset-history).
:::

...
- ObservedValue union accepts scalar (int, float, str, bool), list, dict, and None shapes.
...
# ---------------------------------------------------------------------------
# ObservedValue union shapes
# ---------------------------------------------------------------------------


@pytest.mark.unit
def test_observed_value_int() -> None:
    """ObservedValue accepts int scalar."""
...
def test_observed_value_float() -> None:
    """ObservedValue accepts float scalar."""
...
def test_observed_value_str() -> None:
    """ObservedValue accepts string scalar."""
...
def test_observed_value_bool() -> None:
    """ObservedValue accepts bool scalar."""
...
def test_observed_value_none() -> None:
    """ObservedValue defaults to None."""
...
def test_observed_value_explicit_none() -> None:
    """ObservedValue accepts explicit None."""

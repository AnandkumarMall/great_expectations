...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test that include_unexpected_rows works correctly for ExpectColumnValuesToNotBeInSet."""
    expectation = gxe.ExpectColumnValuesToNotBeInSet(column=NUMBERS_COLUMN, value_set=[1, 2])

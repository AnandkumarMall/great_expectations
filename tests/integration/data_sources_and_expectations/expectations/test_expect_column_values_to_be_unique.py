...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test that include_unexpected_rows works correctly for ExpectColumnValuesToBeUnique."""
    expectation = gxe.ExpectColumnValuesToBeUnique(column=DUPLICATE_STRINGS)
    ...
    assert DUPLICATE_STRINGS in unexpected_rows_df.columns

...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test include_unexpected_rows for ExpectColumnValuesToMatchLikePattern."""
    expectation = gxe.ExpectColumnValuesToMatchLikePattern(column=BASIC_PATTERNS, like_pattern="a%")
    ...
    assert BASIC_PATTERNS in unexpected_rows_df.columns

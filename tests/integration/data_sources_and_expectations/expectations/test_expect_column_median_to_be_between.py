...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test that include_unexpected_rows works correctly for ExpectColumnMedianToBeBetween."""
    expectation = gxe.ExpectColumnMedianToBeBetween(column=COL_NAME, min_value=2.5, max_value=3.5)
    result = batch_for_datasource.validate(

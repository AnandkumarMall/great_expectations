...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test that include_unexpected_rows works correctly for ExpectColumnMinToBeBetween."""
    expectation = gxe.ExpectColumnMinToBeBetween(column=COL_NAME, min_value=4, max_value=6)
    result = batch_for_datasource.validate(

...
def test_include_unexpected_rows(batch_for_datasource: Batch) -> None:
    """Test that include_unexpected_rows works correctly for ExpectColumnValueLengthsToEqual."""
    expectation = gxe.ExpectColumnValueLengthsToEqual(column=SAME_COL, value=2)
    ...
    assert SAME_COL in unexpected_rows_df.columns

...
def test_atomic_prescriptive_summary_expect_column_proportion_of_unique_values_to_be_between(
    ...
    assert res == {
        ...
        "value": {
            "params": {
                "column": {"schema": {"type": "string"}, "value": "my_column"},
                "max_value": {"schema": {"type": "number"}, "value": 0.2},
                "max_value_pct": {"schema": {"type": "string"}, "value": "20%"},
                "min_value": {"schema": {"type": "number"}, "value": 0.1},
                "min_value_pct": {"schema": {"type": "string"}, "value": "10%"},
            },
            "schema": {"type": "com.superconductive.rendered.string"},
            "template": "$column proportion of unique values must be greater than or equal to $min_value_pct and less than or equal to $max_value_pct.",  # noqa: E501 # FIXME CoP
        },
        "value_type": "StringValueType",
    }

...
def test_polish_and_ratchet_pins_and_upper_bounds():
    ...
    assert set(sorted_packages_with_pins_or_upper_bounds) == {
        ...
        ("requirements-dev-lite.txt", "pact-python", (("<", "4"), (">=", "3.0.0"))),
        ...
        ("requirements-dev-sqlalchemy.txt", "pact-python", (("<", "4"), (">=", "3.0.0"))),
        ...
        ("requirements-dev-test.txt", "pact-python", (("<", "4"), (">=", "3.0.0"))),
        ...
        ("requirements-dev.txt", "pact-python", (("<", "4"), (">=", "3.0.0"))),
        (

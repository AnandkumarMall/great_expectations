...
def type_schema(  # noqa: C901 - too complex
    ...
    supported_expectations = [
        ...
        core.ExpectColumnChisquareTestPValueToBeGreaterThan,
        core.ExpectColumnBootstrappedKsTestPValueToBeGreaterThan,
        core.ExpectColumnParameterizedDistributionKsTestPValueToBeGreaterThan,
        core.ExpectColumnPairCramersPhiValueToBeLessThan,
